 ...
 */
public class ImportaProduto2 extends javax.swing.JDialog {

    /** Creates new form ImportaProduto */
    public ImportaProduto2(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jTextField1.setToolTipText("Digite um Detakhe para realizar a busca!");
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ImportaProduto2 dialog = new ImportaProduto2(new javax.swing.JFrame(), true);
 ...
 // siscom.bean.VendaDet v;
    prime.bean.OrcDet o;

  /*
   public void recebeObjeto(  siscom.bean.VendaDet v) {
      this.v = v;
  }
  */
